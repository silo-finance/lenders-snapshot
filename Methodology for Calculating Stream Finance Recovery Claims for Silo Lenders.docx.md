...
This document describes the methodology used by SiloDAO to reconstruct lender balances and calculate recovery claims against Stream Finance. It accompanies the claim submission prepared by SiloDAO and serves as the public technical reference for users wishing to verify or reproduce the calculations.
...
SiloDAO has submitted recovery claims through its legal counsel on behalf of lenders with exposure to Stream-issued assets (xUSD and xBTC). These claims do not include lenders with exposure through Trevee- or Pendle-issued assets, which follow separate recovery processes. Users with eligible Stream claims do not need to submit individual claims.

• Lender Snapshots UI: [https://silo-finance.github.io/lenders-snapshot/](https://silo-finance.github.io/lenders-snapshot/)
