...
// Path segments after the app base path, e.g. `/lenders-snapshot/trevee/sonic/0x..`
// under base `/lenders-snapshot` yields ["trevee", "sonic", "0x.."].
...
// The first path segment is the snapshot category slug (e.g. "trevee"), or null at
